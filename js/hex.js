...
hexReady(function(){
  ...
  function getHeroBackgroundImage(){
    ...
    if(
      ...
      activeHero=window.hexHero.getActive();
    }else{
      hero=document.querySelector(".hex-hero-wrap");

      if(!hero){
        return "";
      }

      activeHero=window.matchMedia("(max-width:768px)").matches
        ?hero.querySelector(".hex-hero-sp")
        :hero.querySelector(".hex-hero-pc");
    }
    ...
    image=activeHero.querySelector(".hex-hero-bg img");
